...
const ConsultaDeDenuncia = () => {
  const [documento, setDocumento] = useState(""); // Estado para almacenar el ID ingresado
  ...
  useEffect(() => {
    const fetchServicios = async () => {
      try {
        ...
        setDenuncias(data); // Almacenar los servicios recibidos en el estado local
...
export default ConsultaDeDenuncia;
